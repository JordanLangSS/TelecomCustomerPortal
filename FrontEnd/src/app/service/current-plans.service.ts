...
export class CurrentPlansService {
  ...
  public addCurrentPlan(currentPlan: CurrentPlan): Observable<CurrentPlan> {
    return this.http.post<CurrentPlan>(`${this.apiServeUrl}/currentplan/add`, currentPlan);
  }

  public updateCurrentPlan(currentPlan: CurrentPlan): Observable<CurrentPlan> {
    return this.http.put<CurrentPlan>(`${this.apiServeUrl}/currentplan/update`, currentPlan);
  }

  public deleteCurrentPlan(currentPlanId: number): Observable<void> {
    return this.http.delete<void>(`${this.apiServeUrl}/currentplan/delete/${currentPlanId}`);
  }
}
